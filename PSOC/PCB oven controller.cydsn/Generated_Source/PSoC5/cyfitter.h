...
/* oled */
#define oled_I2C_FF__ADR CYREG_I2C_ADR
#define oled_I2C_FF__CFG CYREG_I2C_CFG
#define oled_I2C_FF__CLK_DIV1 CYREG_I2C_CLK_DIV1
#define oled_I2C_FF__CLK_DIV2 CYREG_I2C_CLK_DIV2
#define oled_I2C_FF__CSR CYREG_I2C_CSR
#define oled_I2C_FF__D CYREG_I2C_D
#define oled_I2C_FF__MCSR CYREG_I2C_MCSR
#define oled_I2C_FF__PM_ACT_CFG CYREG_PM_ACT_CFG5
#define oled_I2C_FF__PM_ACT_MSK 0x04u
#define oled_I2C_FF__PM_STBY_CFG CYREG_PM_STBY_CFG5
#define oled_I2C_FF__PM_STBY_MSK 0x04u
#define oled_I2C_FF__TMOUT_CFG0 CYREG_I2C_TMOUT_CFG0
#define oled_I2C_FF__TMOUT_CFG1 CYREG_I2C_TMOUT_CFG1
#define oled_I2C_FF__TMOUT_CSR CYREG_I2C_TMOUT_CSR
#define oled_I2C_FF__TMOUT_SR CYREG_I2C_TMOUT_SR
#define oled_I2C_FF__XCFG CYREG_I2C_XCFG
#define oled_I2C_IRQ__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define oled_I2C_IRQ__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define oled_I2C_IRQ__INTC_MASK 0x8000u
#define oled_I2C_IRQ__INTC_NUMBER 15u
#define oled_I2C_IRQ__INTC_PRIOR_NUM 7u
#define oled_I2C_IRQ__INTC_PRIOR_REG CYREG_NVIC_PRI_15
#define oled_I2C_IRQ__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define oled_I2C_IRQ__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* OK_BUTTON */
#define OK_BUTTON__0__INTTYPE CYREG_PICU12_INTTYPE3
#define OK_BUTTON__0__MASK 0x08u
#define OK_BUTTON__0__PC CYREG_PRT12_PC3
#define OK_BUTTON__0__PORT 12u
#define OK_BUTTON__0__SHIFT 3u
#define OK_BUTTON__AG CYREG_PRT12_AG
#define OK_BUTTON__BIE CYREG_PRT12_BIE
#define OK_BUTTON__BIT_MASK CYREG_PRT12_BIT_MASK
#define OK_BUTTON__BYP CYREG_PRT12_BYP
#define OK_BUTTON__DM0 CYREG_PRT12_DM0
#define OK_BUTTON__DM1 CYREG_PRT12_DM1
#define OK_BUTTON__DM2 CYREG_PRT12_DM2
#define OK_BUTTON__DR CYREG_PRT12_DR
#define OK_BUTTON__INP_DIS CYREG_PRT12_INP_DIS
#define OK_BUTTON__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU12_BASE
#define OK_BUTTON__MASK 0x08u
#define OK_BUTTON__PORT 12u
#define OK_BUTTON__PRT CYREG_PRT12_PRT
#define OK_BUTTON__PRTDSI__DBL_SYNC_IN CYREG_PRT12_DBL_SYNC_IN
#define OK_BUTTON__PRTDSI__OE_SEL0 CYREG_PRT12_OE_SEL0
#define OK_BUTTON__PRTDSI__OE_SEL1 CYREG_PRT12_OE_SEL1
#define OK_BUTTON__PRTDSI__OUT_SEL0 CYREG_PRT12_OUT_SEL0
#define OK_BUTTON__PRTDSI__OUT_SEL1 CYREG_PRT12_OUT_SEL1
#define OK_BUTTON__PRTDSI__SYNC_OUT CYREG_PRT12_SYNC_OUT
#define OK_BUTTON__PS CYREG_PRT12_PS
#define OK_BUTTON__SHIFT 3u
#define OK_BUTTON__SIO_CFG CYREG_PRT12_SIO_CFG
#define OK_BUTTON__SIO_DIFF CYREG_PRT12_SIO_DIFF
#define OK_BUTTON__SIO_HYST_EN CYREG_PRT12_SIO_HYST_EN
#define OK_BUTTON__SIO_REG_HIFREQ CYREG_PRT12_SIO_REG_HIFREQ
#define OK_BUTTON__SLW CYREG_PRT12_SLW

/* UP_BUTTON */
#define UP_BUTTON__0__INTTYPE CYREG_PICU12_INTTYPE4
#define UP_BUTTON__0__MASK 0x10u
#define UP_BUTTON__0__PC CYREG_PRT12_PC4
#define UP_BUTTON__0__PORT 12u
#define UP_BUTTON__0__SHIFT 4u
#define UP_BUTTON__AG CYREG_PRT12_AG
#define UP_BUTTON__BIE CYREG_PRT12_BIE
#define UP_BUTTON__BIT_MASK CYREG_PRT12_BIT_MASK
#define UP_BUTTON__BYP CYREG_PRT12_BYP
#define UP_BUTTON__DM0 CYREG_PRT12_DM0
#define UP_BUTTON__DM1 CYREG_PRT12_DM1
#define UP_BUTTON__DM2 CYREG_PRT12_DM2
#define UP_BUTTON__DR CYREG_PRT12_DR
#define UP_BUTTON__INP_DIS CYREG_PRT12_INP_DIS
#define UP_BUTTON__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU12_BASE
#define UP_BUTTON__MASK 0x10u
#define UP_BUTTON__PORT 12u
#define UP_BUTTON__PRT CYREG_PRT12_PRT
#define UP_BUTTON__PRTDSI__DBL_SYNC_IN CYREG_PRT12_DBL_SYNC_IN
#define UP_BUTTON__PRTDSI__OE_SEL0 CYREG_PRT12_OE_SEL0
#define UP_BUTTON__PRTDSI__OE_SEL1 CYREG_PRT12_OE_SEL1
#define UP_BUTTON__PRTDSI__OUT_SEL0 CYREG_PRT12_OUT_SEL0
#define UP_BUTTON__PRTDSI__OUT_SEL1 CYREG_PRT12_OUT_SEL1
#define UP_BUTTON__PRTDSI__SYNC_OUT CYREG_PRT12_SYNC_OUT
#define UP_BUTTON__PS CYREG_PRT12_PS
#define UP_BUTTON__SHIFT 4u
#define UP_BUTTON__SIO_CFG CYREG_PRT12_SIO_CFG
#define UP_BUTTON__SIO_DIFF CYREG_PRT12_SIO_DIFF
#define UP_BUTTON__SIO_HYST_EN CYREG_PRT12_SIO_HYST_EN
#define UP_BUTTON__SIO_REG_HIFREQ CYREG_PRT12_SIO_REG_HIFREQ
#define UP_BUTTON__SLW CYREG_PRT12_SLW

/* DOWN_BUTTON */
#define DOWN_BUTTON__0__INTTYPE CYREG_PICU12_INTTYPE2
#define DOWN_BUTTON__0__MASK 0x04u
#define DOWN_BUTTON__0__PC CYREG_PRT12_PC2
#define DOWN_BUTTON__0__PORT 12u
#define DOWN_BUTTON__0__SHIFT 2u
#define DOWN_BUTTON__AG CYREG_PRT12_AG
#define DOWN_BUTTON__BIE CYREG_PRT12_BIE
#define DOWN_BUTTON__BIT_MASK CYREG_PRT12_BIT_MASK
#define DOWN_BUTTON__BYP CYREG_PRT12_BYP
#define DOWN_BUTTON__DM0 CYREG_PRT12_DM0
#define DOWN_BUTTON__DM1 CYREG_PRT12_DM1
#define DOWN_BUTTON__DM2 CYREG_PRT12_DM2
#define DOWN_BUTTON__DR CYREG_PRT12_DR
#define DOWN_BUTTON__INP_DIS CYREG_PRT12_INP_DIS
#define DOWN_BUTTON__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU12_BASE
#define DOWN_BUTTON__MASK 0x04u
#define DOWN_BUTTON__PORT 12u
#define DOWN_BUTTON__PRT CYREG_PRT12_PRT
#define DOWN_BUTTON__PRTDSI__DBL_SYNC_IN CYREG_PRT12_DBL_SYNC_IN
#define DOWN_BUTTON__PRTDSI__OE_SEL0 CYREG_PRT12_OE_SEL0
#define DOWN_BUTTON__PRTDSI__OE_SEL1 CYREG_PRT12_OE_SEL1
#define DOWN_BUTTON__PRTDSI__OUT_SEL0 CYREG_PRT12_OUT_SEL0
#define DOWN_BUTTON__PRTDSI__OUT_SEL1 CYREG_PRT12_OUT_SEL1
#define DOWN_BUTTON__PRTDSI__SYNC_OUT CYREG_PRT12_SYNC_OUT
#define DOWN_BUTTON__PS CYREG_PRT12_PS
#define DOWN_BUTTON__SHIFT 2u
#define DOWN_BUTTON__SIO_CFG CYREG_PRT12_SIO_CFG
#define DOWN_BUTTON__SIO_DIFF CYREG_PRT12_SIO_DIFF
#define DOWN_BUTTON__SIO_HYST_EN CYREG_PRT12_SIO_HYST_EN
#define DOWN_BUTTON__SIO_REG_HIFREQ CYREG_PRT12_SIO_REG_HIFREQ
#define DOWN_BUTTON__SLW CYREG_PRT12_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 78000000U
#define BCLK__BUS_CLK__KHZ 78000U
#define BCLK__BUS_CLK__MHZ 78U
#define CY_PROJECT_NAME "PCB oven controller"
...
#define CYDEV_VDDIO0 3.0
#define CYDEV_VDDIO0_MV 3000
#define CYDEV_VDDIO1 3.0
#define CYDEV_VDDIO1_MV 3000
#define CYDEV_VDDIO2 3.0
#define CYDEV_VDDIO2_MV 3000
#define CYDEV_VDDIO3 3.0
#define CYDEV_VDDIO3_MV 3000
#define CYDEV_VIO0 3.0
#define CYDEV_VIO0_MV 3000
#define CYDEV_VIO1 3.0
#define CYDEV_VIO1_MV 3000
#define CYDEV_VIO2 3.0
#define CYDEV_VIO2_MV 3000
