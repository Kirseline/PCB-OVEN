// ======================================================================
// PCB oven controller.v generated from TopDesign.cysch
// 07/31/2022 at 21:32
...
module top ;
	...
	wire [0:0] tmpOE__OK_BUTTON_net;
	wire [0:0] tmpFB_0__OK_BUTTON_net;
	wire [0:0] tmpIO_0__OK_BUTTON_net;
	wire [0:0] tmpINTERRUPT_0__OK_BUTTON_net;
	electrical [0:0] tmpSIOVREF__OK_BUTTON_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		OK_BUTTON
		 (.oe(tmpOE__OK_BUTTON_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__OK_BUTTON_net[0:0]}),
		  .io({tmpIO_0__OK_BUTTON_net[0:0]}),
		  .siovref(tmpSIOVREF__OK_BUTTON_net),
		  .interrupt({tmpINTERRUPT_0__OK_BUTTON_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OK_BUTTON_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UP_BUTTON_net;
	wire [0:0] tmpFB_0__UP_BUTTON_net;
	wire [0:0] tmpIO_0__UP_BUTTON_net;
	wire [0:0] tmpINTERRUPT_0__UP_BUTTON_net;
	electrical [0:0] tmpSIOVREF__UP_BUTTON_net;

	cy_psoc3_pins_v1_10
		#(.id("e8203b49-da6b-4c69-bb18-e570775a86a1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UP_BUTTON
		 (.oe(tmpOE__UP_BUTTON_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UP_BUTTON_net[0:0]}),
		  .io({tmpIO_0__UP_BUTTON_net[0:0]}),
		  .siovref(tmpSIOVREF__UP_BUTTON_net),
		  .interrupt({tmpINTERRUPT_0__UP_BUTTON_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UP_BUTTON_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DOWN_BUTTON_net;
	wire [0:0] tmpFB_0__DOWN_BUTTON_net;
	wire [0:0] tmpIO_0__DOWN_BUTTON_net;
	wire [0:0] tmpINTERRUPT_0__DOWN_BUTTON_net;
	electrical [0:0] tmpSIOVREF__DOWN_BUTTON_net;

	cy_psoc3_pins_v1_10
		#(.id("91108a2d-a9c3-42de-84e5-8b946af353c1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DOWN_BUTTON
		 (.oe(tmpOE__DOWN_BUTTON_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DOWN_BUTTON_net[0:0]}),
		  .io({tmpIO_0__DOWN_BUTTON_net[0:0]}),
		  .siovref(tmpSIOVREF__DOWN_BUTTON_net),
		  .interrupt({tmpINTERRUPT_0__DOWN_BUTTON_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DOWN_BUTTON_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
